    ...
    <div class="tentangkami1-wrapper">
        <div class="row justify-content-between">
            ...
            <div class="col-md-6 bg-dosen-header">
                <img src="{{ asset('img/tentangkami/foto1.jpg') }}" alt="">
            </div>
        </div>
    </div>
</div>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="d-flex m-5">
                    <div class="card card-contact me-5">
                        <div class="card-body">
                            <div class="icon">
                            ...
                            <p class="my-2">humas@pens.ac.id</p>
                        </div>
                    </div>
                    ...
                    <div class="card card-contact">
                        <div class="card-body">
                            <div class="icon">
                                ...
                                <p class="my-2">Jl. Raya ITS – Kampus PENS Sukolilo, Surabaya 60111, INDONESIA</p>
                            </div>
                        </div>
                    </div>
                </div>
