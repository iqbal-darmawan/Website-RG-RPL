<!DOCTYPE html>
<html>
@include('components/v_head')
<body>
  @include('components/v_nav')
    <!-- Header -->
    @include('components/v_topnav')
                ...
                <tbody class="list">
                  ...
                  <tr>
                    <th scope="row">
                      <div class="media align-items-center">
                        <a href="#" class="avatar rounded-circle mr-3">
                          <img alt="Image placeholder" src="{{asset('template/')}}/assets/img/theme/angular.jpg">
                        </a>
                        <div class="media-body">
                  ...
                  <tr>
                    <th scope="row">
                      <div class="media align-items-center">
                        <a href="#" class="avatar rounded-circle mr-3">
                          <img alt="Image placeholder" src="{{asset('template/')}}/assets/img/theme/sketch.jpg">
                        </a>
                        <div class="media-body">
                  ...
                  <tr>
                    <th scope="row">
                      <div class="media align-items-center">
                        <a href="#" class="avatar rounded-circle mr-3">
                          <img alt="Image placeholder" src="{{asset('template/')}}/assets/img/theme/vue.jpg">
                        </a>
                        <div class="media-body">
